...
<body>
    <div id="container">
        ...
        <input type="number" id="numValues" min="1" max="10" value="2">
    ...
    <script>
        function generarCampos() {
            ...
            if (isNaN(numValues) || numValues < 1 || numValues > 10) {
                alert("Ingresa un número válido entre 1 y 10 para la cantidad de valores.");
                return;
            }
